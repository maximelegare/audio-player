...
export async function getServerSideProps() {
  ...
  SELECT DISTINCT (a.title), s.duration, s.id ,s.title, s.liked, s.album, s.title_route as song_route, a.title_route as album_route, s.streaming_url, s.RP_streaming_path, a.artist_route, a.picture_url, a.artist, 'hodei' as provider 
  FROM songs s
  JOIN albums a 
  ON a.title = s.album
  WHERE s.liked = 1
